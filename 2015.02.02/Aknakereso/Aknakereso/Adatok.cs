...
namespace Aknakereso
{
    class Adatok
    {
        ...
        public void ertekSzamol(int i, int j)
        {
            ...
            {
                if (j < Adatok.M - 2 && mezoGomb[i, j + 1].Text.Equals("-1"))
                { //jobbra
                    ertek += 1;
                }
                if (i > 0 && j < Adatok.M - 2 && mezoGomb[i - 1, j + 1].Text.Equals("-1"))
                { //felette jobbra
                    ertek += 1;
                }
                if (i < Adatok.N - 2 && j > 0 && mezoGomb[i + 1, j - 1].Text.Equals("-1"))
                { //alatta balra
                    ertek += 1;
                }
                if (i < Adatok.N - 2 && j < Adatok.M - 2 && mezoGomb[i + 1, j + 1].Text.Equals("-1"))
                { //alatta jobbra
                    ertek += 1;
                }
                ...
                if (i < Adatok.N - 2 && mezoGomb[i + 1, j].Text.Equals("-1"))
                { //alatta
                    ertek += 1;
                }
            }
