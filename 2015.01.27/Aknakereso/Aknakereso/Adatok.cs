...
namespace Aknakereso
{
    class Adatok
    {
        ...
        public int ertekSzamol(int i, int j)
        {
            ...
            if (mezoGomb[i, j + 1].Text.Equals("-1") && j < m)
            { //jobbra
                ertek += 1;
            }
            else if (mezoGomb[i - 1, j + 1].Text.Equals("-1") && i > 1 && j < m)
            { //felette jobbra
                ertek += 1;
            }
            else if (mezoGomb[i + 1, j - 1].Text.Equals("-1") && i < 1 && j < m)
            ...
            else if (mezoGomb[i + 1, j + 1].Text.Equals("-1") && i < n && j < m)
            { //alatta jobbra
                ertek += 1;
            }
            else if (mezoGomb[i, j - 1].Text.Equals("-1") && j > m)
            { //balra
                ertek += 1;
            }
            else if (mezoGomb[i - 1, j].Text.Equals("-1") && i > n)
            { //fele
                ertek += 1;
            }
            else if (mezoGomb[i - 1, j - 1].Text.Equals("-1") && i > n && j > m)
