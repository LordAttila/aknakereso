...
namespace Aknakereso
{
    class Adatok
    {
        ...
        private Label pontszam1L;
        private Label pontszam2L;
        ...
        public Adatok(Label label1, Label label2)
        {
            pontszam1L = label1;
            pontszam2L = label2;
        }
                ...
                for (int j = 0; j < Adatok.M; j++)
                {
                    if (mezoGomb[i, j].Text.Equals("-1"))
                    {
                        if (JATEKOS)
                        {
                            ...
                            {
                                pontszam1++;
                                pontszam1L.Text = pontszam1.ToString();
                            }
                        ...
                        else if (!JATEKOS)
                        {
                            ...
                            {
                                pontszam2++;
                                pontszam2L.Text = pontszam2.ToString();
                            }
                        }
                        //MessageBox.Show(pontszam1.ToString() + " " + pontszam2.ToString());
                    }
                }
            }
            JATEKOS = !JATEKOS;
